...
import javax.servlet.http.HttpSession;import org.apache.ibatis.reflection.SystemMetaObject;
...
public class ChatController {
	...
	public String create(String name, RedirectAttributes rttr) {
		...
		return "redirect:/chat/rooms";	// -> @GetMapping("/rooms")로 간다 => 방을 생성하고 이름을 넣어주면 방목록이 뜬다
	}
	@GetMapping("/room")
